...
const Signup = () => {
  ...
  const onSubmit = async (data: SignupForm) => {
    ...
    // Create user session immediately after signup
    const user = {
    ...
    toast({
      ...
      description: `Welcome ${data.firstName}! You can now start your learning journey.`,
    });
    
    setIsLoading(false);
    
    // Redirect to home instead of login since user is now logged in
    setLocation("/");
  };
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Welcome ${user.firstName || user.email}! Your account has been created.`,
      });
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-8">
        <Card className="w-full max-w-md mx-auto bg-black/40 backdrop-blur-xl border-purple-500/30">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-bold text-white">Join CareerLaunch</CardTitle>
            <CardDescription className="text-gray-300">
              Create your account and start your tech career journey today
            </CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            >
              ...
              {isGoogleLoading ? 'Signing up...' : googleAvailable ? 'Continue with Google' : 'Configure Google OAuth'}
            </Button>
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-300">
                ...
                <Link href="/login">
                  <span className="text-blue-400 hover:text-blue-300 cursor-pointer underline" data-testid="login-link">
                    Sign in here
                  </span>
                </Link>
              </p>
